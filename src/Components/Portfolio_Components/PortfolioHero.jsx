  ...
  return (
    ...
    <section className="relative h-screen bg-gray-50 flex flex-col overflow-hidden font-sans">
      ...
      <div className="flex justify-between items-center px-6 py-6 z-10 lg:px-24">
        ...
        <span className="text-gray-900 text-lg tracking-wider cursor-pointer font-normal">Home</span>
        ...
        <span className="text-gray-900 text-lg tracking-wider cursor-pointer font-normal">Contact Us</span>
      </div>
